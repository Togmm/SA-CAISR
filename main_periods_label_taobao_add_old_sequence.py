...
parser.add_argument('--scaling_lr', default=1.3, type=float)
...
if __name__ == '__main__':
    ...
    for period in periods:
        ...
        train_sampler = Sampler_DPO_add_old_sequence(new_data, args.maxlen, args.batch_size, max_item, False)
        ...
        if args.inference_only:
            args.state_dict_path = '/data/wangxinru-slurm/project/Rec/SASRec/SASRec/TAOBAO_continual_learning_add_old_sequence_warmup_lr_scal/period2/epoch=10.ckpt'
        ...
        optimizer, scheduler = create_optimizer_and_scheduler(args, model, num_batch)
        for epoch in range(1, args.num_epochs + 1):
            ...
            args.lr = args.lr / args.scaling_lr #if batch+1 >= 4*checkpoint_interval else lr
