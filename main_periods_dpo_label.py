...
from model import SASRec_DPO_label
from utils import *
...
if __name__ == '__main__':
    ...
    model = SASRec_DPO_label(itemnum, args).to(args.device)
    ...
    for period in periods:
        ...
        if args.inference_only:
            args.state_dict_path = '/data/wangxinru-slurm/project/Rec/SASRec/SASRec/TAOBAO_TAOBAO_DPO_LABEL/period2/epoch=44.ckpt'
        ...
        for epoch in range(1, args.num_epochs + 1):
            ...
            for step in range(num_batch): # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
                ...
                pos_logits_ref, neg_logits_ref = model_ref(seq, pos, neg)
