...
from model import SASRec_DPO_argmax
from utils import *
...
if __name__ == '__main__':
    ...
    model = SASRec_DPO_argmax(itemnum, args).to(args.device)
    ...
    for period in periods:
        ...
        if args.inference_only:
            args.state_dict_path = '/data/wangxinru-slurm/project/Rec/SASRec/SASRec/TAOBAO_TAOBAO_FINTUNE_SEQ/period2/epoch=1.ckpt'
        ...
        valid_sampler = Sampler(user_valid, args.maxlen, args.test_batch, True)
        ...
        for epoch in range(1, args.num_epochs + 1):
            ...
            for step in range(num_batch): # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
                ...
                win_logits, lose_logits = model(flag, length, seq, pos, max_item)
                win_logits_ref, lose_logits_ref = model_ref(flag, length, seq, pos, max_item)
                adam_optimizer.zero_grad()
                loss = dpo_loss(args.beta, win_logits, lose_logits, win_logits_ref, lose_logits_ref)
